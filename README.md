...
El proyecto aborda la detección temprana de fuga de clientes bajo un escenario de clases desbalanceadas.
El desafío principal consistió en la construcción de un pipeline robusto capaz de mitigar el ruido en la 
ingesta y garantizar la generalización del modelo en entornos de producción.
